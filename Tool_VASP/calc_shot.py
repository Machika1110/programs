...
# POSCAR is Direct & Selective dynamics
# POSCAR needs shot atom ex) Ge + Ni

path_vasp = "/home/owner/VASP/vasp.6.4.0/bin/vasp_std"
mpi_num = "16"
initv = -0.1   # unit : Angs. / fs
x_pos = 0.0      # random defined later
y_pos = 0.0      # random defined later
z_pos = 0.6
...
for calc_num in range(int(args.n)):
    ...
    if calc_num == 0:
        ...
        # copy XDATCAR -> you can combine them OVITO
        shutil.copy("XDATCAR", "../XDATCAR{}".format(str(i+1)))
        os.chdir("..")

    # second and more steps    
    else:
